...
const DayView = ({day}) => {
  ...
  return (
    <div className="daycontainer">
      ...
      <i className={day.isDone===true?"fa-solid fa-circle-check circleicon actives":"fa-solid fa-circle-check circleicon"} onClick={markToDone}></i>
      <i className={day.isDone===false?"fa-solid fa-circle-xmark circleicon actives":"fa-solid fa-circle-xmark circleicon"} onClick={markToUnDone}></i>
      <i className={day.isDone===""?"fa-solid fa-circle-minus circleicon actives":"fa-solid fa-circle-minus circleicon"} onClick={markToNone}></i>
    </div>
  );
};
